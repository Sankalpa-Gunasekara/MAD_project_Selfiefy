...
import com.bug_sniffers.selfiefy.Adapter.TodoAdapter;
...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newTaskText = Objects.requireNonNull(getView()).findViewById(R.id.todo_newText);
        newTaskSaveButton = getView().findViewById(R.id.btnSave);
        ...
        if(bundle != null){
            ...
            assert task != null;
            if(task.length()>0)
                newTaskSaveButton.setTextColor(ContextCompat.getColor(Objects.requireNonNull(getContext()), R.color.slightDark_blue));
        }
